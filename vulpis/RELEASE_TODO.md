...
2. Complete Vulpis branding in executable metadata, installer, icons, native about/settings UI and localized product names. Preserve copyright/attribution notices and upstream technical identifiers. Upstream MPL illustrations are not automatically unlicensed; review their use separately from product marks.
...
8. Keep stock Mozilla updates disabled until a separately signed Vulpis update channel is implemented and tested. Each update needs a corresponding source tag, hashes, verification, staged rollout and recovery behavior.
